...
<html>
 ...
 <body>
  ...
  <div class="container">
    <form id ="J_Form" class="form-horizontal" action="${webapp.context}admin/webapp/edit.html" method="post">
      <h3>基本信息</h3>
      <div class="row">
          <div class="control-group span12">
                <label class="control-label"><s>*</s>名称：</label>
            <div class="controls">
                <input name="name" type="text" class="control-text" data-rules="{required:true}" value="${zhan.name}">
            </div>
          </div>
      </div>
      <div class="row">
          <div class="control-group span12">
            ...
            <div class="controls control-row-auto">
                <textarea name="descript" class="control-row4 input-large" data-rules="{required:true}">${zhan.descript}</textarea>
            </div>
          </div>
      </div>
      <hr/>
