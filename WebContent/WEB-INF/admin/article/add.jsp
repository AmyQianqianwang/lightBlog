...
<html>
 ...
 <body>
  ...
  <div class="container">
    <form id ="J_Form" class="form-horizontal" action="${webapp.context}admin/article/add.html" method="post">
      <h3>基本</h3>
      <div class="row">
       ...
       <div class="row">
          <div class="control-group span12">
               ...
               <div class="controls">
                    <input name="tags" type="text" style="width: 300px;">
               </div>
          </div>
      </div>
      <hr/>
      <h3>内容</h3>
      <textarea name="content" id="editor" placeholder="这里输入内容" style="width: 100%;height: 120px;"></textarea>
