...
<html>
 ...
 <body>
  ...
  <div class="container">
    <form id ="J_Form" class="form-horizontal" action="${webapp.context}admin/user/add.html" method="post">
      <h3>基本信息</h3>
      <div class="row">
      ...
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="nick" type="text" class="control-text" data-rules="{required:true}">
          </div>
        </div>
      ...
      <div class="row">
        <div class="control-group span24">
          ...
          <div class="controls control-row4">
            <textarea name="remark" id="remark" class="span8 span-width"></textarea>
          </div>
        </div>
      </div>
      <hr/>
