...
<html>
 ...
 <body>
  ...
  <div class="container">
    <form id ="J_Form" class="form-horizontal" action="${webapp.context}admin/user/auth/edit.html" method="post">
      <h3>基本信息</h3>
      <div class="row">
        <div class="control-group span12">
          <label class="control-label"><s>*</s>URI：</label>
          <div class="controls">
            <input name="uri" type="text" class="control-text" data-rules="{required:true}" value="${userAuth.uri}">
          </div>
        </div>
        <div class="control-group span12">
      ...
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="descript" type="text" class="control-text" data-rules="{required:true}" value="${userAuth.descript}">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="descriptEn" type="text" class="control-text" data-rules="{required:true}" value="${userAuth.descriptEn}">
          </div>
        </div>
      </div>
      <hr/>
      ...
      <input type="hidden" name="id" value="${userAuth.id}">
    </form>
  </div>
